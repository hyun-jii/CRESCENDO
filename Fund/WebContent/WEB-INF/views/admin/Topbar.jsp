			...
			<li class="nav-item dropdown no-arrow">
			 ...
			 <!-- Dropdown - User Information -->
				<div
					...
					<!-- 로그아웃 -->
					<a class="dropdown-item" data-toggle="modal" data-target="#logoutModal" id="logoutbtn" > 
