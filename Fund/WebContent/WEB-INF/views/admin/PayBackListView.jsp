											...
											<table class="table table-bordered dataTable" id="dataTable"
												...
												<thead>
													<tr role="row">
														...
														<th class="sorting" tabindex="0" aria-controls="dataTable"
															rowspan="1" colspan="1"
															aria-label="Age: activate to sort column ascending">후원자</th>
														<th class="sorting" tabindex="0" aria-controls="dataTable"
															rowspan="1" colspan="1"
														...
														<th class="sorting" tabindex="0" aria-controls="dataTable"
															rowspan="1" colspan="1"
															aria-label="Salary: activate to sort column ascending">환불 사유</th>
														<th class="sorting" tabindex="0" aria-controls="dataTable"
															rowspan="1" colspan="1"
												...
												<tbody>
													<c:forEach var="r" items="${ list }">
														<tr role="row" class="odd">
															<td class="sorting_1">${ r.pbNum }</td>
															<td><a href="#" target="_blank" style="text-decoration:none; color: gray;">${ r.prjTitle}</a></td>
															<td>${ r.userName}</td>
															<td>${ r.poDate}</td>
															<td>${ r.poMoney}원</td>
															<td>${ r.pbContent}</td>
