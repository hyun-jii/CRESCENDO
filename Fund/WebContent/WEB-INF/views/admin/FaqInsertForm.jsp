		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="faq_container" style="width: 90%; margin-left: 100px; margin-top: 50px;">
					<form action="faqinsert.action" method="post" id="insertfaq" role="form">
						<label for="faqTitle">제목 입력</label> 
							<input type="text" id="hTitle" name="hTitle" placeholder="제목을 입력하세요">

						<label for="faqContent">내용 입력</label>
							<textarea id="hContent" name="hContent" placeholder="공지사항 내용을 입력하세요." style="height: 500px"></textarea>
							
							
						<div class="faqBtn" style="float: right;">
							<input type="button" value="취소하기" class="resetFaq"> 
