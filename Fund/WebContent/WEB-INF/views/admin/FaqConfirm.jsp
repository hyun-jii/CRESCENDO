		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="faq_container" style="width: 90%; margin-left: 100px; margin-top: 50px;">
					<form action="faqconfirm.action" method="post" id="confirmfaq" role="form">
						<label for="faqTitle">제목</label> 
							<input type="text" id="noTitle" name="hTitle" readonly="readonly" placeholder="${data.hTitle }">

						<label for="noticeContent">내용</label>
							<textarea id="hContent" name="hContent" readonly="readonly" style="height: 500px">${data.hContent}</textarea>
							
							
						<div class="faqBtn" style="float: right;">
							<input type="button" value="확인" class="faqLsit">
						</div>
					</form>
				</div>
