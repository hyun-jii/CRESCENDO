		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<!-- Page Heading -->
					<h1 class="h3 mb-2 text-gray-800"># 진행중인 프로젝트 (진행중)</h1>
					<br>
					<!-- DataTales Example -->
											...
											<table class="table table-bordered dataTable" id="dataTable"
												...
												<thead>
													<tr role="row">
														...
														<th class="sorting" tabindex="0" aria-controls="dataTable"
															rowspan="1" colspan="1"
															aria-label="Start date: activate to sort column ascending">남은기간</th>
														<th class="sorting" tabindex="0" aria-controls="dataTable"
															rowspan="1" colspan="1"
															aria-label="Salary: activate to sort column ascending">종료일</th>
														<th class="sorting" tabindex="0" aria-controls="dataTable"
															rowspan="1" colspan="1"
															aria-label="Salary: activate to sort column ascending">창작자</th>
														<th class="sorting" tabindex="0" aria-controls="dataTable"
															rowspan="1" colspan="1"
															aria-label="Salary: activate to sort column ascending">현재 펀딩금액</th>
														<th class="sorting" tabindex="0" aria-controls="dataTable"
															rowspan="1" colspan="1"
												...
												<tbody>
													<c:forEach var="list" items="${ list }">
														<tr role="row" class="odd">
															<td class="sorting_1">${list.proNum }</td>
															<td>${list.caName}</td>
															<td>
																<a href="projectdetail.action?proNum=${list.proNum }" style="text-decoration:none; color: gray;">${list.prjTitle }</a>
															</td>
															<td>${list.prjGoal }원</td>
															<td>${list.remainDay }일</td>
															<td>${list.finalDay }</td>
															<td>
																<a href="makerpage.action?userNum=${list.userNum}&maName=${list.maName}" style="text-decoration:none; color: gray;">${list.maName }</a>
															</td>
															<td>${list.poMoney }원</td>
															<td>${list.maBank}${list.maAccount }</td>
															<td>${list.percent }%</td>
														</tr>
														</c:forEach>
														<%-- 
