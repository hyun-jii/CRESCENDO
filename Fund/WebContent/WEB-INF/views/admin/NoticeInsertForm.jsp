			...
			<div id="content">
				...
				<!-- Begin Page Content -->
			 	...
			 	<div class="noticeHead" style="margin-left: 100px; color: black; font-weight: bold;">
					<p><h1>공지사항 내용 입력</h1></p>
				</div>
			
				<div class="notice_container" style="width: 90%; margin-left: 100px; margin-top: 50px;">
					<form action="noticeinsert.action" method="post" id="insertNotice" role="form">
						<label for="noticeTitle">제목 입력</label> 
							<input type="text" id="noTitle" name="noTitle" placeholder="제목을 입력하세요">

						<label for="noticeContent">내용 입력</label>
							<textarea id="noContent" name="noContent" placeholder="공지사항 내용을 입력하세요." style="height: 500px"></textarea>
