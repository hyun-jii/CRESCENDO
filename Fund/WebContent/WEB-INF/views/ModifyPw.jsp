...
<!-- 비밀번호 변경 css 경로 -->
<link rel="stylesheet" type="text/css" href="css/modifypw.css">
			...
			<div class="main-pw">
				...
				<form id="Login">
					...
					<div class="form-group">
						<div>
							<span class="newPw">새로운 비밀번호 입력</span>
							<input type="password" class="form-control" placeholder="새로운 비밀번호를 입력해주세요">
						</div>
					</div>

					<div class="form-group">
						<div>
							<span class="reInputPw">비밀번호 재입력</span>
							<input type="password" class="form-control" placeholder="비밀번호를 다시 입력해주세요">
						</div>
						<!-- 비밀번호가 일치하지 않을 때 -->
						<div  style="display: none;" id="pwMsg">
							<span>비밀번호가 서로 일치하지 않습니다. 다시 확인해주세요</span>
						</div>
					</div>
