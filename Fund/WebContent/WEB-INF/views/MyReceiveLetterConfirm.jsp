...
<body>
  ...
  <jsp:include page="top.jsp"></jsp:include>
			...
			<div class="letterHead" style="margin-left: 100px; color: black; font-weight: bold;">
			    ...
			    <form action="letterupdatedate.action" id="ReadDateUpdate" role="form">
					 <input type="hidden" value="${data.leNum }" name="leNum" id="leNum">
						...
						<label for="leContent">내용</label><br><br>
							...
							<input type="submit" class="btn btn-warning" value="확인" style=" margin-left: 37%; margin-top: 5px;"> <br><br>
				</form>
				</div>
				</div>
				<br><br><br><br>
