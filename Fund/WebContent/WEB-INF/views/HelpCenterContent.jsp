					...
					<div class="row">
						<div class="col-sm-12">
							<table class="table dataTable" id="dataTable"
								style="font-size: 15px; border: none; background-color: white;" cellspacing="0" role="grid"
								aria-describedby="dataTable_info">
								<tr>
									<th>
										<h4 class="topTitle">✍ ${list.hTitle }</h4>
									</th>
								</tr>
								<tr>
									<td>
							...
							<div>
								<button type="button" class="backList">목록으로</button>
							</div>
						</div>
					</div>
